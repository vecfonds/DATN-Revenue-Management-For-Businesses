...
const InDoanhThuSanPham = ({ components, dataSource, columns, form, disabled, onFinish, idHoaDon, idCustomer, dates }) => {
    ...
    return (
        <>
            ...
            <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow-sm my-6" id="invoice">
                ...
                <h1 className="text-center font-bold text-2xl mt-2">BÁO CÁO DOANH THU THEO SẢN PHẨM</h1>
...
export default InDoanhThuSanPham